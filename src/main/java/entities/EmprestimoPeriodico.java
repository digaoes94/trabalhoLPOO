...
@Entity @Table(name = "empréstimo")
public class EmprestimoPeriodico {
	...
	public EmprestimoPeriodico() {

	}

	public EmprestimoPeriodico(String cpfMutuario, LocalDate inicioEmprestimo, LocalDate fimEmprestimo,LocalDate dataRealDevolucao, boolean status) {
