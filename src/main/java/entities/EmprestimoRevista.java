...
public class EmprestimoRevista {
	...
	public EmprestimoRevista() {

	}

	public EmprestimoRevista(String cpfMutuario, LocalDate inicioEmprestimo, LocalDate fimEmprestimo,LocalDate dataRealDevolucao, boolean status) {
